...
//        if($this->socket === false && $error_code === 0){
//            $this->socket = fsockopen($this->url_parts["host"], $this->url_parts["port"], $error_code, $error_str, $this->socketConnectTimeout);
//            if($this->socket === false && $error_code === 0){
//                $this->socket = fopen($this->UrlDescriptor->url_rebuild, "r");
//            }
//        }
      }
      else
